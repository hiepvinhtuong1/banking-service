...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity,  CustomJwtDecoder customJwtDecoder, CustomAccessDeniedHandler accessDeniedHandler) throws Exception {
        httpSecurity
                ...
                // Đăng ký authentication provider để support cho jwt token
                // Khi mà thực hiện reqeust cung cấp 1 token vào header authentication thì sẽ thực hiện việc authentication
    ...
    public UrlBasedCorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000","http://localhost:5173")); // dùng patterns thay vì origins
