...
import { selectCurrentActiveAccount } from "~/redux/account/accountSlice";

function CreateCardForm() {
	const navigate = useNavigate();
	const account = useSelector(selectCurrentActiveAccount);
	const accountId = account?.accountId; // 👉 lấy trực tiếp từ redux
	const {
		register,
		handleSubmit,
		formState: { errors },
		...
		<Container disableGutters maxWidth={false}>
			<Box sx={{ paddingX: 2, my: 4 }}>
				<Breadcrumbs sx={{ mb: 2 }}>
					...
					<Typography color="text.primary">Create Card</Typography>
				</Breadcrumbs>
			</Box>
